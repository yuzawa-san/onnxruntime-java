...
# NOTE: verify does not work since libclang is in a weird location
RUN sh ./gradlew --no-daemon -Pjdk_home=/opt/java/openjdk -Pllvm_home=/usr/lib/llvm-18 clean assemble
