...
/**
 * {@snippet lang=c :
 * typedef void (*OrtThreadPoolWorkStartFn)(void *, void *)
 * }
 */
public final class OrtThreadPoolWorkStartFn {

    private OrtThreadPoolWorkStartFn() {
    ...
    private static final MethodHandle UP$MH =
            onnxruntime_all_h.upcallHandle(OrtThreadPoolWorkStartFn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(OrtThreadPoolWorkStartFn.Function fi, Arena arena) {
