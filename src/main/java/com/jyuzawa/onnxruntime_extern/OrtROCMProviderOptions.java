...
public class OrtROCMProviderOptions {
    ...
    static final VarHandle miopen_conv_exhaustive_search$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("miopen_conv_exhaustive_search"));
    ...
    static final VarHandle gpu_mem_limit$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("gpu_mem_limit"));
    ...
    static final VarHandle arena_extend_strategy$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("arena_extend_strategy"));
    ...
    static final VarHandle do_copy_in_default_stream$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("do_copy_in_default_stream"));
    ...
    public static MemoryAddress user_compute_stream$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtROCMProviderOptions.user_compute_stream$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle default_memory_arena_cfg$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("default_memory_arena_cfg"));
    ...
    public static MemoryAddress default_memory_arena_cfg$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtROCMProviderOptions.default_memory_arena_cfg$VH.get(seg.asSlice(index*sizeof()));
    }
