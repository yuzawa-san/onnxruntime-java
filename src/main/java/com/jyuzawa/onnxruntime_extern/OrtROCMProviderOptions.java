...
public class OrtROCMProviderOptions {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                    ...
                    onnxruntime_all_h.C_INT.withName("miopen_conv_exhaustive_search"),
    ...
    private static final OfInt miopen_conv_exhaustive_search$LAYOUT =
            (OfInt) $LAYOUT.select(groupElement("miopen_conv_exhaustive_search"));
