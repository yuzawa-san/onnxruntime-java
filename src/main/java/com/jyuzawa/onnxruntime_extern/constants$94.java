...
final class constants$94 {
    ...
    static final MethodHandle const$1 =
            RuntimeHelper.upcallHandle(OrtApi.SessionOptionsSetCustomJoinThreadFn.class, "apply", constants$15.const$4);
    ...
    static final MethodHandle const$3 =
            RuntimeHelper.upcallHandle(OrtApi.SetGlobalCustomCreateThreadFn.class, "apply", constants$15.const$4);
    static final VarHandle const$4 =
            constants$16.const$4.varHandle(MemoryLayout.PathElement.groupElement("SetGlobalCustomCreateThreadFn"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(
            OrtApi.SetGlobalCustomThreadCreationOptions.class, "apply", constants$15.const$4);
}
