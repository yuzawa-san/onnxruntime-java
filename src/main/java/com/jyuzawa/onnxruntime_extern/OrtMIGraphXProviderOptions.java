...
public class OrtMIGraphXProviderOptions {
    ...
    static final VarHandle migraphx_fp16_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("migraphx_fp16_enable"));
    ...
    static final VarHandle migraphx_int8_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("migraphx_int8_enable"));
