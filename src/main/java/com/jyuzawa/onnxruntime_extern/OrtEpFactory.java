...
public class OrtEpFactory {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                    ...
                    onnxruntime_all_h.C_POINTER.withName("SelectBestModelCandidate"))
     ...
     * }
     */
    public static final class SelectBestModelCandidate {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(SelectBestModelCandidate.Function.class, "apply", $DESC);
    ...
    private static final AddressLayout SelectBestModelCandidate$LAYOUT =
            (AddressLayout) $LAYOUT.select(groupElement("SelectBestModelCandidate"));
    ...
    private static final long SelectBestModelCandidate$OFFSET =
            $LAYOUT.byteOffset(groupElement("SelectBestModelCandidate"));
