...
/**
 * {@snippet lang=c :
 * typedef void (*OrtThreadPoolWorkAbandonFn)(void *, void *)
 * }
 */
public final class OrtThreadPoolWorkAbandonFn {

    private OrtThreadPoolWorkAbandonFn() {
    ...
    private static final MethodHandle UP$MH =
            onnxruntime_all_h.upcallHandle(OrtThreadPoolWorkAbandonFn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(OrtThreadPoolWorkAbandonFn.Function fi, Arena arena) {
