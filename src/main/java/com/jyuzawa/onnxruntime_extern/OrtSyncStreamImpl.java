...
public class OrtSyncStreamImpl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                    ...
                    onnxruntime_all_h.C_POINTER.withName("GetHandle"),
                    onnxruntime_all_h.C_POINTER.withName("CreateNotification"),
                    onnxruntime_all_h.C_POINTER.withName("Flush"),
                    onnxruntime_all_h.C_POINTER.withName("OnSessionRunEnd"))
    ...
    public static final class GetHandle {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(GetHandle.Function.class, "apply", $DESC);
    ...
    public static final class CreateNotification {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(CreateNotification.Function.class, "apply", $DESC);
    ...
    private static final AddressLayout CreateNotification$LAYOUT =
            (AddressLayout) $LAYOUT.select(groupElement("CreateNotification"));
    ...
    public static final class Flush {
        ...
        private static final MethodHandle UP$MH = onnxruntime_all_h.upcallHandle(Flush.Function.class, "apply", $DESC);
     ...
     * }
     */
    public static final class OnSessionRunEnd {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(OnSessionRunEnd.Function.class, "apply", $DESC);
    ...
    private static final AddressLayout OnSessionRunEnd$LAYOUT =
            (AddressLayout) $LAYOUT.select(groupElement("OnSessionRunEnd"));
