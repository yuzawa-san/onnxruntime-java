...
public class OrtSyncNotificationImpl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                    ...
                    onnxruntime_all_h.C_POINTER.withName("Activate"),
                    onnxruntime_all_h.C_POINTER.withName("WaitOnDevice"),
                    onnxruntime_all_h.C_POINTER.withName("WaitOnHost"))
    ...
    public static final class Activate {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(Activate.Function.class, "apply", $DESC);
     ...
     * }
     */
    public static final class WaitOnDevice {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(WaitOnDevice.Function.class, "apply", $DESC);
    ...
    private static final AddressLayout WaitOnDevice$LAYOUT =
            (AddressLayout) $LAYOUT.select(groupElement("WaitOnDevice"));
     ...
     * }
     */
    public static final class WaitOnHost {
        ...
        private static final MethodHandle UP$MH =
                onnxruntime_all_h.upcallHandle(WaitOnHost.Function.class, "apply", $DESC);
