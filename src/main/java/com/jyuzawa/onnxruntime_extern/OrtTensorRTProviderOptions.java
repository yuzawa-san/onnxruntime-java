...
public class OrtTensorRTProviderOptions {
    ...
    static final VarHandle has_user_compute_stream$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("has_user_compute_stream"));
    ...
    static final VarHandle user_compute_stream$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("user_compute_stream"));
    ...
    public static MemoryAddress user_compute_stream$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtTensorRTProviderOptions.user_compute_stream$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle trt_max_partition_iterations$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_max_partition_iterations"));
    ...
    static final VarHandle trt_min_subgraph_size$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_min_subgraph_size"));
    ...
    static final VarHandle trt_max_workspace_size$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_max_workspace_size"));
    ...
    static final VarHandle trt_fp16_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_fp16_enable"));
    ...
    static final VarHandle trt_int8_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_int8_enable"));
    ...
    static final VarHandle trt_int8_calibration_table_name$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_int8_calibration_table_name"));
    ...
    public static MemoryAddress trt_int8_calibration_table_name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtTensorRTProviderOptions.trt_int8_calibration_table_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle trt_int8_use_native_calibration_table$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_int8_use_native_calibration_table"));
    ...
    public static int trt_int8_use_native_calibration_table$get(MemorySegment seg, long index) {
        return (int)OrtTensorRTProviderOptions.trt_int8_use_native_calibration_table$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle trt_dla_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_dla_enable"));
    ...
    static final VarHandle trt_dla_core$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_dla_core"));
    ...
    static final VarHandle trt_dump_subgraphs$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_dump_subgraphs"));
    ...
    static final VarHandle trt_engine_cache_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_engine_cache_enable"));
    ...
    static final VarHandle trt_engine_cache_path$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_engine_cache_path"));
    ...
    public static MemoryAddress trt_engine_cache_path$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtTensorRTProviderOptions.trt_engine_cache_path$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle trt_engine_decryption_enable$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_engine_decryption_enable"));
    ...
    static final VarHandle trt_engine_decryption_lib_path$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_engine_decryption_lib_path"));
    ...
    public static MemoryAddress trt_engine_decryption_lib_path$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtTensorRTProviderOptions.trt_engine_decryption_lib_path$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle trt_force_sequential_engine_build$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("trt_force_sequential_engine_build"));
