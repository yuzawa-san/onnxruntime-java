...
public class OrtCUDAProviderOptions {
    ...
    static final VarHandle cudnn_conv_algo_search$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("cudnn_conv_algo_search"));
    ...
    public static MemoryAddress user_compute_stream$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtCUDAProviderOptions.user_compute_stream$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress default_memory_arena_cfg$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)OrtCUDAProviderOptions.default_memory_arena_cfg$VH.get(seg.asSlice(index*sizeof()));
    }
