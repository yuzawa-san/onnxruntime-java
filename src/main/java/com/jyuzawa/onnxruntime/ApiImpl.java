...
final class ApiImpl implements Api {
	...
	final SessionOptionsAppendExecutionProvider_TensorRT SessionOptionsAppendExecutionProvider_TensorRT;
	...
	final CreateSessionFromArrayWithPrepackedWeightsContainer CreateSessionFromArrayWithPrepackedWeightsContainer;
	...
	ApiImpl(MemorySegment segment){
		...
		this.CreateEnvWithCustomLoggerAndGlobalThreadPools  = OrtApi.CreateEnvWithCustomLoggerAndGlobalThreadPools(segment);
		this.SessionOptionsAppendExecutionProvider_CUDA  = OrtApi.SessionOptionsAppendExecutionProvider_CUDA(segment);
		this.SessionOptionsAppendExecutionProvider_ROCM  = OrtApi.SessionOptionsAppendExecutionProvider_ROCM(segment);
		this.SessionOptionsAppendExecutionProvider_OpenVINO  = OrtApi.SessionOptionsAppendExecutionProvider_OpenVINO(segment);
		...
		this.SessionOptionsAppendExecutionProvider_TensorRT  = OrtApi.SessionOptionsAppendExecutionProvider_TensorRT(segment);
		...
		this.CreateSessionWithPrepackedWeightsContainer  = OrtApi.CreateSessionWithPrepackedWeightsContainer(segment);
		this.CreateSessionFromArrayWithPrepackedWeightsContainer  = OrtApi.CreateSessionFromArrayWithPrepackedWeightsContainer(segment);
		this.SessionOptionsAppendExecutionProvider_TensorRT_V2  = OrtApi.SessionOptionsAppendExecutionProvider_TensorRT_V2(segment);
		...
		this.CreateSparseTensorWithValuesAsOrtValue  = OrtApi.CreateSparseTensorWithValuesAsOrtValue(segment);
		...
		this.SessionOptionsSetCustomCreateThreadFn  = OrtApi.SessionOptionsSetCustomCreateThreadFn(segment);
		this.SessionOptionsSetCustomThreadCreationOptions  = OrtApi.SessionOptionsSetCustomThreadCreationOptions(segment);
		...
		this.SetGlobalCustomThreadCreationOptions  = OrtApi.SetGlobalCustomThreadCreationOptions(segment);
